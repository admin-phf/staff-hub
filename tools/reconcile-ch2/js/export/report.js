(function(global){
  ...
  async function exportReference(invoiceDocs,refs){
    const outputs=PHF.linkedPos.buildReferenceOutputs(invoiceDocs,refs);if(!outputs.length)throw new Error('No supplier invoice output could be created.');
